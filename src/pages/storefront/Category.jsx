...
export default function Category() {
  ...
  // Create category context for UnifiedSlotRenderer
  const categoryContext = {
    category: currentCategory,
    products: paginatedProducts,
    allProducts: products, // Use unfiltered products for filter counting
    productLabels: productLabels || [], // Add product labels directly to context
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Dynamic layout using UnifiedSlotRenderer */}
      ...
      {isStoreOwner && (
        <a
          href={`/ai-workspace?page=category&item=${categorySlug}&edit=true`}
          target="_top"
