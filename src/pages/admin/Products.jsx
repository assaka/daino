                      ...
                      {paginatedProducts.map((product) => {
                        ...
                        return (
                          <tr key={product.id} className={`border-b border-gray-100 hover:bg-gray-50 ${selectedProducts.has(product.id) ? 'bg-blue-50' : ''}`}>
                            ...
                            <td className="py-3 md:py-4 sm:px-2 md:px-4">
                              {translationMode ? (
                                ...
                                <div className="flex items-center sm:space-x-2 md:space-x-3">
                                  <div className="w-10 h-10 md:w-12 md:h-12 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    {product.images && product.images.length > 0 && !failedImages.has(product.id) ? (
                                      <img
                                        src={getPrimaryImageUrl(product.images)}
                                  ...
                                  <div className="min-w-0 flex-1 max-w-[100px] md:max-w-none">
