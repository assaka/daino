                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-blue-600">Attributes with type <code className="bg-blue-100 px-1 rounded text-blue-700">pim_catalog_image</code> are automatically mapped to product images</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-blue-600">Attributes with type <code className="bg-blue-100 px-1 rounded text-blue-700">pim_catalog_file</code> are automatically mapped to product files</p>
                      </div>
                      <Switch
