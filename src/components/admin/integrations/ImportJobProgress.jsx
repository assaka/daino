      ...
      <div key={job.id} className="border rounded-lg p-4 space-y-3">
          ...
          <div className="text-sm bg-green-50 p-2 rounded">
            {job.result.stats && (
              <div className="flex gap-4">
                <span>Imported: <strong className="text-green-600">{job.result.stats.imported || job.result.stats.created || 0}</strong></span>
        ...
        {job.status === JOB_STATUS.CANCELLED && job.result?.stats && (
          <div className="text-sm bg-gray-50 p-2 rounded">
            <div className="flex gap-4">
              <span>Imported before cancel: <strong className="text-blue-600">{job.result.stats.imported || job.result.stats.created || 0}</strong></span>
