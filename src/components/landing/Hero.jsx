        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-50 text-slate-900 pt-20">
            ...
            <div className="relative z-10 max-w-3xl mx-auto px-6 py-12 text-center">
                <motion.h1
                    ...
                    className="text-4xl md:text-6xl lg:text-8xl font-black mb-8 leading-tight text-slate-900"
                >
                    Build any store
                    <br />
                    <AnimatePresence mode="wait">
                        <motion.span
                            ...
                            className="text-indigo-600 inline-block text-3xl md:text-5xl lg:text-7xl"
                        >
