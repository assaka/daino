...
const headerConfig = {
  ...
  slots: {
    ...
    search_section: {
      ...
      type: 'container',
      content: '',
      className: 'flex justify-center px-2 min-w-0',
    ...
    actions_section: {
      ...
      type: 'container',
      content: '',
      className: 'flex items-center justify-end space-x-1 md:space-x-2 min-w-0',
      parentClassName: '',
      styles: {},
      parentId: 'header_top_row',
      position: { col: 9, row: 1 },
      colSpan: 'col-span-8 md:col-span-4 lg:col-span-3',
      viewMode: ['default'],
      metadata: {
        hierarchical: true,
