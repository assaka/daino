...
{{/each}}`,
  ...
  <div data-coupon-input-section class="flex gap-2">
    ...
    <button data-action="apply-coupon" class="px-4 py-2 text-white rounded-md btn-themed transition-all" style="background-color: {{settings.theme.primary_button_color}}">{{t "common.apply"}}</button>
  </div>
  ...
  <button data-action="checkout" class="w-full py-3 text-white rounded-md btn-checkout transition-all font-medium" style="background-color: {{settings.theme.checkout_button_color}}">
