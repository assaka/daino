...
--   - admin_navigation_registry (plugin items only - core items now in master DB admin_navigation_core)
--   - categories
...
-- NOTE: Core navigation items have been moved to master DB (admin_navigation_core table)
