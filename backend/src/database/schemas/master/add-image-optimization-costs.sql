...
-- ============================================
-- Provider  | Compress | Upscale | Remove BG | Stage | Convert | Custom
-- ----------|----------|---------|-----------|-------|---------|--------
-- OpenAI    | 0.5 cr   | 1.5 cr  | 1.5 cr    | 2.5 cr| 0.3 cr  | 2.5 cr
-- Gemini    | 0.3 cr   | 0.8 cr  | 0.8 cr    | 1.5 cr| 0.2 cr  | 1.5 cr
-- Flux      | 0.4 cr   | 0.6 cr  | 0.5 cr    | 1.8 cr| 0.2 cr  | 1.8 cr
-- Qwen      | 0.2 cr   | 0.5 cr  | 0.5 cr    | 1.2 cr| 0.15 cr | 1.2 cr
-- ============================================
