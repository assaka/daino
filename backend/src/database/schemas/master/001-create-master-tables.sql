...
VALUES
    ...
    ('b2c3d4e5-f6a7-4890-bcde-111111111111', 'woocommerce_integration', 'WooCommerce', 'ShoppingCart', '/admin/woocommerce-integration', 'import_export', 4, true, 'import_export', NULL, 'Import products and categories from WooCommerce', NULL, 'standard', NOW(), NOW()),
    ('a1b2c3d4-e5f6-7890-abcd-000000000030', 'workflow_integrations', 'Workflows', 'Webhook', '/admin/integrations/workflows', 'import_export', 5, true, 'import_export', NULL, 'n8n, Zapier, Make webhook automations', NULL, 'standard', NOW(), NOW()),
    ('5415ee5a-1276-4883-ac01-33d3dfcb1c2b', 'import_export_jobs', 'Jobs & Analytics', 'BarChart3', '/admin/import-export-jobs', 'import_export', 6, true, 'import_export', NULL, 'Monitor import/export jobs and view performance analytics', NULL, 'standard', NOW(), NOW()),
