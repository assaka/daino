...
('store', 'Store', 'Store configuration with settings including theme. settings JSON contains: theme (preset name or custom overrides), currency, timezone, etc.', 'stores', 'id', NULL,
 '["languages", "slot_configurations", "theme_defaults"]',
 '["get", "update"]',
 '[
   ...
   {"name": "settings", "type": "json", "description": "Store settings JSON. Contains theme settings that override theme_defaults preset values."},
...
-- Theme Defaults (Master DB table with theme presets)
('theme_defaults', 'Theme Defaults', 'Theme presets with complete styling. theme_settings JSONB contains all colors, fonts, and layout settings. Store settings.theme can reference a preset or override individual values.', 'theme_defaults', 'id', NULL,
 '["stores"]',
 '["list", "get", "create", "update", "delete"]',
 '[
   {"name": "id", "type": "uuid", "description": "Theme preset ID"},
   {"name": "preset_name", "type": "string", "description": "Unique preset name (default, red, ocean, forest, etc.)"},
   {"name": "display_name", "type": "string", "description": "Human-readable name"},
   {"name": "description", "type": "text", "description": "Theme description"},
   {"name": "is_system_default", "type": "boolean", "description": "Is the default theme for new stores"},
   {"name": "is_active", "type": "boolean"},
   {"name": "type", "type": "enum", "values": ["system", "custom"], "description": "system=built-in, custom=user-created"},
   {"name": "sort_order", "type": "integer"},
   {"name": "theme_settings", "type": "jsonb", "description": "Complete theme settings - see theme_settings entity for structure"}
 ]',
 '["theme", "preset", "colors", "styling", "design"]',
 '["list theme presets", "get default theme", "create custom theme"]',
 'settings', 95, true),

-- Theme Settings Structure (documentation entity for theme_settings JSONB)
('theme_settings', 'Theme Settings Structure', 'Documentation of theme_settings JSONB structure in theme_defaults and stores.settings. NOT a table - describes the JSON schema.', '_schema_theme_settings', 'N/A', NULL,
 '["theme_defaults", "stores"]',
 '["get"]',
 '[
   {"name": "font_family", "type": "string", "description": "Font family (Inter, Roboto, etc.)"},

   {"name": "primary_button_color", "type": "color", "description": "Primary button background color"},
   {"name": "secondary_button_color", "type": "color", "description": "Secondary button background color"},
   {"name": "add_to_cart_button_bg_color", "type": "color", "description": "Add to cart button background"},
   {"name": "add_to_cart_button_text_color", "type": "color", "description": "Add to cart button text"},
   {"name": "add_to_cart_button_hover_color", "type": "color", "description": "Add to cart button hover"},
   {"name": "add_to_cart_button_border_radius", "type": "string", "description": "Border radius (sm, md, lg, xl)"},
   {"name": "view_cart_button_color", "type": "color"},
   {"name": "checkout_button_color", "type": "color"},
   {"name": "place_order_button_color", "type": "color"},

   {"name": "header_bg_color", "type": "color", "description": "Header background color"},
   {"name": "header_icon_color", "type": "color", "description": "Header icon color"},
   {"name": "header_padding_top", "type": "string", "description": "Header top padding in px"},
   {"name": "header_padding_bottom", "type": "string", "description": "Header bottom padding in px"},
   {"name": "header_search_bg_color", "type": "color"},
   {"name": "header_search_border_color", "type": "color"},
   {"name": "header_search_border_radius", "type": "string", "description": "sm, md, lg, xl"},
   {"name": "header_search_text_color", "type": "color"},
   {"name": "header_nav_bg_color", "type": "color"},
   {"name": "header_nav_text_color", "type": "color"},
   {"name": "header_nav_hover_color", "type": "color"},
   {"name": "header_nav_hover_bg_color", "type": "color"},
   {"name": "header_nav_active_color", "type": "color"},
   {"name": "header_nav_active_bg_color", "type": "color"},
   {"name": "header_nav_padding_x", "type": "string", "description": "Horizontal padding in px"},
   {"name": "header_nav_padding_y", "type": "string", "description": "Vertical padding in px"},
   {"name": "header_subnav_bg_color", "type": "color"},
   {"name": "header_subnav_text_color", "type": "color"},
   {"name": "header_subnav_hover_color", "type": "color"},
   {"name": "header_subnav_hover_bg_color", "type": "color"},
   {"name": "header_nav_expand_icon", "type": "string", "description": "Icon name for expand"},
   {"name": "header_nav_collapse_icon", "type": "string", "description": "Icon name for collapse"},

   {"name": "layered_nav_card_bg_color", "type": "color", "description": "Filter sidebar background"},
   {"name": "layered_nav_header_text_color", "type": "color"},
   {"name": "layered_nav_filter_label_color", "type": "color"},
   {"name": "layered_nav_option_text_color", "type": "color"},
   {"name": "layered_nav_option_hover_color", "type": "color"},
   {"name": "layered_nav_option_count_color", "type": "color"},
   {"name": "layered_nav_checkbox_color", "type": "color"},
   {"name": "layered_nav_active_filter_bg_color", "type": "color"},
   {"name": "layered_nav_active_filter_text_color", "type": "color"},

   {"name": "breadcrumb_show_home_icon", "type": "boolean"},
   {"name": "breadcrumb_item_text_color", "type": "color"},
   {"name": "breadcrumb_item_hover_color", "type": "color"},
   {"name": "breadcrumb_active_item_color", "type": "color"},
   {"name": "breadcrumb_separator_color", "type": "color"},
   {"name": "breadcrumb_font_size", "type": "string", "description": "e.g., 0.875rem"},
   {"name": "breadcrumb_mobile_font_size", "type": "string"},
   {"name": "breadcrumb_font_weight", "type": "string", "description": "400, 500, 600, etc."},

   {"name": "product_tabs_title_color", "type": "color"},
   {"name": "product_tabs_title_size", "type": "string"},
   {"name": "product_tabs_content_bg", "type": "color"},
   {"name": "product_tabs_content_color", "type": "color"},
   {"name": "product_tabs_attribute_label_color", "type": "color"},
   {"name": "product_tabs_active_bg", "type": "color"},
   {"name": "product_tabs_inactive_color", "type": "color"},
   {"name": "product_tabs_inactive_bg", "type": "color"},
   {"name": "product_tabs_hover_color", "type": "color"},
   {"name": "product_tabs_hover_bg", "type": "color"},
   {"name": "product_tabs_font_weight", "type": "string"},
   {"name": "product_tabs_border_radius", "type": "string"},
   {"name": "product_tabs_border_color", "type": "color"},
   {"name": "product_tabs_text_decoration", "type": "string"},

   {"name": "checkout_step_indicator_active_color", "type": "color"},
   {"name": "checkout_step_indicator_inactive_color", "type": "color"},
   {"name": "checkout_step_indicator_completed_color", "type": "color"},
   {"name": "checkout_step_indicator_style", "type": "string", "description": "circles, numbers, progress"},
   {"name": "checkout_section_title_color", "type": "color"},
   {"name": "checkout_section_title_size", "type": "string"},
   {"name": "checkout_section_bg_color", "type": "color"},
   {"name": "checkout_section_border_color", "type": "color"},
   {"name": "checkout_section_text_color", "type": "color"},

   {"name": "pagination_button_bg_color", "type": "color"},
   {"name": "pagination_button_text_color", "type": "color"},
   {"name": "pagination_button_hover_bg_color", "type": "color"},
   {"name": "pagination_button_border_color", "type": "color"},
   {"name": "pagination_active_bg_color", "type": "color"},
   {"name": "pagination_active_text_color", "type": "color"},

   {"name": "stock_in_stock_text_color", "type": "color"},
   {"name": "stock_in_stock_bg_color", "type": "color"},
   {"name": "stock_out_of_stock_text_color", "type": "color"},
   {"name": "stock_out_of_stock_bg_color", "type": "color"},
   {"name": "stock_low_stock_text_color", "type": "color"},
   {"name": "stock_low_stock_bg_color", "type": "color"}
 ]',
