...
const aiChatToolsRoutes = require('./routes/ai-chat-tools'); // Tool-based AI chat (dynamic, not static training)
...
app.use('/api/ai/chat-tools', aiChatToolsRoutes); // Tool-based AI chat (dynamic, uses Anthropic tools)
